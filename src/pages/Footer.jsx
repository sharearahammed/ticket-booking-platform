...
const Footer = () => {
  ...
  const pages = [
    ...
    { name: "Refund Policy", path: "/refund-policy-service" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs sm:text-sm md:text-base text-gray-400 leading-relaxed">
              Your one-stop booking platform for movies, events, and
              transportation. Trusted by thousands of happy travelers.
            </p>
            <div className="pt-2">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm md:text-base">
              <ul>
                {Object.entries(links).map(([label, path], idx) => (
                  <li key={idx}>
                    <Link
                      to={path}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 text-xs sm:text-sm md:text-base">
          <div className="text-center md:text-left">
            <p className="text-gray-400">
              © 2025 <span className="font-bold text-white">TicketHub</span>.
              All rights reserved.
            </p>
          </div>
          <div className="text-center">
            <p className="text-gray-400">
              Made with <span className="text-amber-400 animate-pulse">❤️</span>{" "}
              for travelers and event lovers
            </p>
          </div>
