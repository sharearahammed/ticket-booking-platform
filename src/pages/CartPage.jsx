...
import { X, ShoppingCart, Lock, Truck, CheckCircle } from "lucide-react";
        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl p-8 sm:p-12 md:p-16 text-center shadow-lg border-2 border-blue-100">
            <div className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-blue-100 to-emerald-100 mb-6">
              <ShoppingCart
                size={40}
                className="sm:size-[48px] text-blue-600"
              />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {cart.map((item) => (
                <div
                  key={item.cartId}
                  className="bg-white rounded-2xl p-4 sm:p-5 md:p-6 flex gap-3 sm:gap-4 shadow-md hover:shadow-xl transition-all border-2 border-blue-100 hover:border-blue-300 group"
                >
                  {/* Item Image */}
                  <div className="text-3xl sm:text-4xl md:text-5xl flex-shrink-0 bg-gradient-to-br from-blue-100 to-emerald-100 p-3 sm:p-4 rounded-xl group-hover:scale-110 transition-transform">
                    {item.image}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-1 sm:space-y-2 mb-3 sm:mb-4">
                      <div className="flex items-center gap-2 text-sm sm:text-base md:text-lg">
                        ...
                        <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-blue-100 text-blue-700 rounded-lg font-bold text-xs sm:text-sm md:text-base">
                      ...
                      {item.selectedSeats && (
                        <div className="flex items-center gap-2 text-sm sm:text-base md:text-lg">
                          ...
                          <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-emerald-100 text-emerald-700 rounded-lg font-bold text-xs sm:text-sm md:text-base">
              ...
              <div className="bg-white rounded-2xl p-5 sm:p-6 md:p-8 shadow-xl sticky top-24 border-2 border-blue-100">
                ...
                <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-4 sm:p-5 rounded-xl border-2 border-amber-200 mb-6 sm:mb-8">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent">
                ...
                <div className="bg-emerald-50 border-2 border-emerald-200 p-3 sm:p-4 rounded-xl">
                  <div className="flex items-center gap-2 mb-1 sm:mb-2">
                    <CheckCircle
                      size={16}
                      className="sm:w-4 sm:h-4 md:w-5 md:h-5 text-emerald-600"
                    />
        ...
        {cart.length > 0 && (
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border-2 border-emerald-200 text-center hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-gray-600">
                Receive your tickets immediately after payment
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl border-2 border-amber-200 text-center hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-gray-600">
                Limited stock - secure your seats now!
              </p>
            </div>
          </div>
        )}
